...
SET u{STAGE} day-staging;
SET u{DIFFG} day-diff;

SPARQL CREATE SILENT GRAPH <$u{STAGE}>;
SPARQL CLEAR GRAPH <$u{STAGE}>;

DELETE FROM DB.DBA.LOAD_LIST WHERE ll_file = '/home/freundt/author/catasess/days.ttl.repl';
ld_add('/home/freundt/author/catasess/days.ttl.repl', '$u{STAGE}');
rdf_loader_run();
CHECKPOINT;
