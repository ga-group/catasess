...
CREATE DUMP_PROCEDURE(dump_regimes,
SPARQL
DEFINE input:storage ""
PREFIX fibo-fpas: <https://spec.edmcouncil.org/fibo/ontology/FBC/ProductsAndServices/FinancialProductsAndServices/>
PREFIX delta: <http://www.w3.org/2004/delta#>
SELECT ?s ?p ?o
FROM <http://data.ga-group.nl/catasess/regimes/>
WHERE {
	?s a regm:TradingRegime ; ?p ?o
}
);

dump_regimes('/var/scratch/lakshmi/freundt/regimes.ttl');
CHECKPOINT;
