...
SET u{STAGE} sess-staging;
SET u{DIFFG} sess-diff;

SPARQL CREATE SILENT GRAPH <$u{STAGE}>;
SPARQL CLEAR GRAPH <$u{STAGE}>;

DELETE FROM DB.DBA.LOAD_LIST WHERE ll_file = '/home/freundt/author/catasess/sessions.ttl.repl';
ld_add('/home/freundt/author/catasess/sessions.ttl.repl', '$u{STAGE}');
rdf_loader_run();
CHECKPOINT;
